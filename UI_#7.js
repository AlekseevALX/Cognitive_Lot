...
var HideSomeFieldView = function () { //учебное задание скрыть/показать поле 1 в зависимости от чекбокса поле 2
...
scopes.onView(HideSomeFieldView); //учебное задание скрыть/показать поле 1 в зависимости от чекбокса поле 2
